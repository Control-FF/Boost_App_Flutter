...
class _$_CategoryProduct implements _CategoryProduct {
  ...
  @override
  String toString() {
    return 'CategoryProduct(it_id: $it_id, it_name: $it_name, it_cust_price: $it_cust_price, it_price: $it_price, it_img1: $it_img1, it_time: $it_time, it_use_cnt: $it_use_cnt, it_sum_qty: $it_sum_qty)';
  }
