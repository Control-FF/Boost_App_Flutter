...
KeywordResult _$KeywordResultFromJson(Map<String, dynamic> json) {
  return _KeywordResult.fromJson(json);
}

/// @nodoc
mixin _$KeywordResult {
  ...
  @JsonKey(ignore: true)
  $KeywordResultCopyWith<KeywordResult> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $KeywordResultCopyWith<$Res> {
  factory $KeywordResultCopyWith(
          KeywordResult value, $Res Function(KeywordResult) then) =
      _$KeywordResultCopyWithImpl<$Res, KeywordResult>;
  @useResult
  $Res call(
      {String it_id,
      String it_name,
...
/// @nodoc
class _$KeywordResultCopyWithImpl<$Res, $Val extends KeywordResult>
    implements $KeywordResultCopyWith<$Res> {
  _$KeywordResultCopyWithImpl(this._value, this._then);
...
abstract class _KeywordResult implements KeywordResult {
  factory _KeywordResult(
      {final String it_id,
      final String it_name,
      final int it_cust_price,
      final int it_price,
...
KeywordResultResponse _$KeywordResultResponseFromJson(
    Map<String, dynamic> json) {
  return _KeywordResultResponse.fromJson(json);
}

/// @nodoc
mixin _$KeywordResultResponse {
  int get status => throw _privateConstructorUsedError;
  String get message => throw _privateConstructorUsedError;
  @JsonKey(name: 'data')
  List<KeywordResult>? get items => throw _privateConstructorUsedError;
  int get total_cnt => throw _privateConstructorUsedError;

  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $KeywordResultResponseCopyWith<KeywordResultResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $KeywordResultResponseCopyWith<$Res> {
  factory $KeywordResultResponseCopyWith(KeywordResultResponse value,
          $Res Function(KeywordResultResponse) then) =
      _$KeywordResultResponseCopyWithImpl<$Res, KeywordResultResponse>;
  @useResult
  $Res call(
      {int status,
      String message,
      @JsonKey(name: 'data') List<KeywordResult>? items,
      int total_cnt});
}

/// @nodoc
class _$KeywordResultResponseCopyWithImpl<$Res,
        $Val extends KeywordResultResponse>
    implements $KeywordResultResponseCopyWith<$Res> {
  _$KeywordResultResponseCopyWithImpl(this._value, this._then);
...
class _$_KeywordResultResponse implements _KeywordResultResponse {
  ...
  final List<KeywordResult>? _items;
  @override
  @JsonKey(name: 'data')
  List<KeywordResult>? get items {
    final value = _items;
  ...
  @override
  String toString() {
    return 'KeywordResultResponse(status: $status, message: $message, items: $items, total_cnt: $total_cnt)';
  }
...
abstract class _KeywordResultResponse implements KeywordResultResponse {
  factory _KeywordResultResponse(
