...
abstract class $TokenResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {int status, String message, String? accessToken, String? refreshToken});
}
...
class _$_TokenResponse implements _TokenResponse {
  ...
  @override
  String toString() {
    return 'TokenResponse(status: $status, message: $message, accessToken: $accessToken, refreshToken: $refreshToken)';
  }
