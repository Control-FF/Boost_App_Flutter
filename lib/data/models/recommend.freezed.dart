...
mixin _$RecommendResponse {
  ...
  @JsonKey(name: 'data')
  List<Recommend>? get items => throw _privateConstructorUsedError;
...
abstract class $RecommendResponseCopyWith<$Res> {
  factory $RecommendResponseCopyWith(
          RecommendResponse value, $Res Function(RecommendResponse) then) =
      _$RecommendResponseCopyWithImpl<$Res, RecommendResponse>;
  @useResult
  $Res call(
      {int status,
      String message,
      @JsonKey(name: 'data') List<Recommend>? items,
      int total_cnt});
}
...
class _$_RecommendResponse implements _RecommendResponse {
  ...
  final List<Recommend>? _items;
  @override
  @JsonKey(name: 'data')
  List<Recommend>? get items {
    final value = _items;
  ...
  @override
  String toString() {
    return 'RecommendResponse(status: $status, message: $message, items: $items, total_cnt: $total_cnt)';
  }
